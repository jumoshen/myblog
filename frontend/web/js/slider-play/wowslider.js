...
jQuery.fn.wowSlider = function(am) {
    ...
    if (e) {
        ...
        function(c) {
            return false
        }).show().appendTo(X || document.body).attr("target", "_blank"); (function() {
    ...
    if (am.controls) {
        ...
        if (/iPhone/.test(navigator.platform)) {
            ad.get(0).addEventListener("touchend",
            function(c) {
                aU(c, x - 1, 1)
            },
            false);
    ...
    function aX(f, a1, c) {
        var a0 = N(f);
        var a2 = N(a1);
        var k = am.captionEffect; (ac[aI.type(k)] || ac[k] || ac.none)(aI.extend({
            $this: H,
            curIdx: x,
            prevIdx: ax,
            noDelay: c
...
//     h.html(g).css("width", "100%").stop(1, 1); (function a(n, j, v, r, s, w) {
//         var p = 15;
//         var m = d.$this.width();
//         p *= m / 100;
//         function q(z, A) {
