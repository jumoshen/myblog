...
function ws_tv(m, i, b) {
    ...
    this.go = function(h, o) {
        if (k) {
            ...
            0, 1, m.duration * 0.3, "easeOutCubic",
            function() {
                wowAnimate(n, {
                    scale: [0.9, 0],
                    opacity: 0.5
                ...
                m.duration * 0.3, m.duration * 0.4, "easeOutBack2",
                function() {
                    b.find(".ws_list").css({
                        left: (h ? -h + "00%": (/Safari/.test(navigator.userAgent) ? "0%": 0))
                    });
...
function ws_brick(f, s, g) {
    ...
    function e(J, K) {
        var i = 0;
        for (var j in J) {
            if (typeof J[j] !== "function") { (function(L, M) {
                    ...
                    0, 1, M[L].animate.duration, M[L].animate.delay,
                    function() {
                        i++;
                        if (i == M.length && K) {
                            K()
